...
function modifier_item_carapace_of_qaldin:OnCreated( kv )
    ...
    --        self.mana_regen_now = self:GetParent():GetManaRegen()
    --    end
    --end
...
--function modifier_item_carapace_of_qaldin:OnIntervalThink()
--    if IsServer() then
--		if self:GetParent():IsHero() then
--			if self:GetParent():GetManaRegen() - self.mana_regen_now*2 ~= 0 then
--				self.mana_regen_now = self:GetParent():GetManaRegen() - self.mana_regen_now
--			end
--		end
--	end
--end
...
--function modifier_item_carapace_of_qaldin:GetModifierConstantManaRegenUnique( params )
--	return self.mana_regen_now
--end
