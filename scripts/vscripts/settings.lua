...
CUSTOM_GAME_SETUP_TIME = 30			-- How long should custom game setup last - the screen where players pick a team?
...
PRE_GAME_TIME = 30					-- How long after showcase time should the horn blow and the game start?
POST_GAME_TIME = 30					-- How long should we let people stay around before closing the server automatically?
